...
- **`SymplecticFermionQ`** -- `Q(N, beta)`, the symplectic fermion ribbon
  ...
  own normal-form reduction, the R-matrix and ribbon element and their
  inverses, and -- the only one of the three with a sourced formula --
  a two-sided integral and cointegral, the latter via
  Berger-Gainutdinov-Runkel, ["Modified traces for quasi-Hopf
  algebras"](https://arxiv.org/abs/1812.10445).
