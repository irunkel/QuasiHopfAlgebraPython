...
class QuantumSl2Quasi(QuasiHopfAlgebra):
    ...
    def r_matrix(self) -> Element:
        ...
        Ported from ``RR`` in reference/hopf-Uqsl2-quasi.txt (also
        eq:R-quasiH in the paper); K^s E^n and K^r F^n are put in normal
    ...
    def monodromy(self) -> Element:
        ...
        (``mon`` in reference/hopf-Uqsl2-quasi.txt)."""
    ...
    def drinfeld(self) -> Element:
        ...
        Ported from ``drin`` in reference/hopf-Uqsl2-quasi.txt."""
    ...
    def ribbon(self) -> Element:
        ...
        Ported from ``rib`` in reference/hopf-Uqsl2-quasi.txt (also
        eq:ribbon-quasiH in the paper).
    ...
    def f_element(self) -> Element:
        ...
        in reference/hopf-Uqsl2-quasi.txt), used in the S-Delta
